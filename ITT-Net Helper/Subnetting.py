CIDR_dict = {2:1, 4:2, 8:3, 16:4, 32:5, 64:6, 128:7, 256:8, 512:9, 1024:10, 2048:11, 4096:12, 8192:13, 16384:14, 32768:15, 65536:16}
debug = 0
...
def subnet_net_IDs(network_ID, CIDR, num_of_subnets):
    ...
    for i in range(num_of_subnets):
        ...
        #new_net_ID = net_ID[:]
        list_of_net_IDs.append(net_ID[:])
    print(len(list_of_net_IDs))
    return list_of_net_IDs[:-1]
...
def subnet_first_IPs(list_of_net_IDs):
    ...
    print(len(list_of_first_IPs))
    return list_of_first_IPs
...
def subnet_bc_IPs(list_of_net_IDs):
    ...
    print(len(list_of_bc_IPs))
    return list_of_bc_IPs
...
def subnet_last_IPs(list_of_bc_IPs):
    ...
    print(len(list_of_last_IPs))
    return list_of_last_IPs
